...
void Triangle::setColor(int ind, float r, float g, float b) {
    ...
    color[ind] = Vector3f((float)r/255.,(float)g/255.,(float)b/255.); // wyh 归一化0~1
    return;
}
...
std::array<Vector4f, 3> Triangle::toVector4() const // wyh 将三角形3个顶点坐标从Vector3f, 转换成齐次坐标Vector4f
{
